...
<header>
        <div class="container-fluid bg-light" id="intro">
            <br>
            <h1 class="text-center">Bienvenid@ <img src="./img/FazeAdministrador.svg" height="50px"></h1>
            <br>
        </div>
    </header>
    ...
    <div class="container">
        ...
        <br>
            ...
            <div class="row">
                ...
                <a href="addcourse.php" type="button"class="btn btn-success"><i class="fas fa-plus-square"></i>   Añadir Curso</a>
                </div>
                <div class="col text-center">
                <a href="deletecourse.php" type="button"class="btn btn-danger"><i class="fas fa-minus-square"></i>   Eliminar Curso</a>
                </div>
                <div class="col text-center">
                <a href="info.php" type="button"class="btn btn-warning"><i class="fas fa-info"></i> Informacion</a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col text-center">
                <a href="newuser.php" type="button"class="btn btn-success"><i class="fas fa-user-plus"></i> Añadir Usuario</a>
                </div>
                <div class="col text-center">
                <a href="deleteuser.php" type="button"class="btn btn-danger"><i class="fas fa-user-minus"></i> Eliminar Usuario</a>
                </div>
                <div class="col text-center">
                <a href="usersReport.php" type="button"class="btn btn-warning"><i class="fas fa-clipboard"></i> Generar Reporte</a>
                </div>
            </div>
